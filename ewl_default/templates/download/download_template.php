...
if(!isset($DOWNLOAD_CAT_CHILD_TABLE))
{
   $DOWNLOAD_CAT_CHILD_TABLE = "
               <tr>
                  ...
                  <td class='forumheader3' style='text-align:center; background-color: #666;'>
	...
	<form method='post' action='".e_SELF."?".e_QUERY."'>
		<div class='table-responsive'>
            <table id='download' class='table table-striped'>\n
               ...
               <tr>
                  <th style='background-color: #333;'>{DOWNLOAD_LIST_CAPTION=name}</th>
                  <th style='background-color: #333;'>{DOWNLOAD_LIST_CAPTION=datestamp}</th>
                  <th style='background-color: #333;'>{DOWNLOAD_LIST_CAPTION=author}</th>
                  <th style='background-color: #333;'>{DOWNLOAD_LIST_CAPTION=filesize}</th>
                  <th style='background-color: #333;'>{DOWNLOAD_LIST_CAPTION=requested}</th>
                  <th style='background-color: #333;'>{DOWNLOAD_LIST_CAPTION=rating}</th>
                  <th class='text-center' style='background-color: #333;'>{DOWNLOAD_LIST_CAPTION=link}</th>
               </tr>";
...
$DOWNLOAD_TEMPLATE['list']['item'] = "
		         <tr>
		            ...
		            <td class='text-center' style='background-color: #666;'>
		               {DOWNLOAD_LIST_LINK}
		            </td>
		         </tr>";
...
$DOWNLOAD_TEMPLATE['list']['end'] = "
		         <tr>
		         	<td colspan='3' style='background-color: #666;'>{DOWNLOAD_BACK_TO_CATEGORY_LIST}</td>
		            <td colspan='4' style='text-align:right; background-color: #666;'><small class='muted text-muted'>{DOWNLOAD_LIST_TOTAL_AMOUNT} {DOWNLOAD_LIST_TOTAL_FILES}</small></td>
		         </tr>
		      </table>
		</div>
	</form>
