...
$pageTitle = e107::pref('forum','title', LAN_PLUGIN_FORUM_NAME);
...
$FORUM_TEMPLATE['main']['parent']			= 	"<tr class='forum-parent forum-ewlt'>
											<th colspan='2' style='background-color: #1a1a1a;'>{PARENTIMAGE:h=50}{PARENTNAME} {PARENTSTATUS}</th>
											<th class='hidden-xs text-center' style='background-color: #1a1a1a;'>".LAN_FORUM_0003."</th>
											<th class='text-center' style='background-color: #1a1a1a;'>".LAN_FORUM_0002."</th>
											<th class='hidden-xs text-center' style='background-color: #1a1a1a;'>".LAN_FORUM_0004."</th>
											</tr>";


// style='background-color: #777;'
$FORUM_TEMPLATE['main']['forum']			= 	"<tr class='forum-ewltable'>
											<td class='forum-ewltable'>{NEWFLAG}</td>
											<td class='forum-ewltable'>{FORUMIMAGE:h=50}{FORUMNAME}<br /><small>{FORUMDESCRIPTION}</small>{FORUMSUBFORUMS}</td>
											<td class='hidden-xs text-center forum-ewltd' style='background-color: #666;'>{REPLIESX}</td>
											<td class='text-center forum-ewltd' style='background-color: #666;'>{THREADSX}</td>
											<td class='hidden-xs text-center' style='background-color: #666;'><small>{LASTPOST:type=username} {LASTPOST:type=datelink}</small></td>
											</tr>";
$FORUM_TEMPLATE['footer'] 				= "
...
$FORUM_TEMPLATE['main']['end']				= "</table>
											...
											<div class='forum-footer center'><small>{USERINFOX}</small></div></div>
