...
$FORUM_VIEWFORUM_TEMPLATE['item'] 				= "<tr>
												    <td style='background-color: #777;'>{ICON}</td>
												    ...
												    <td class='text-center' style='background-color: #666;'>{REPLIESX}</td>
													<td class='hidden-xs text-center' style='background-color: #666;'>{VIEWSX}</td>
												    <td class='hidden-xs' style='background-color: #666;'><small>{LASTPOSTUSER} {LASTPOSTDATE} </small>
															<div class='span2 right float-right pull-right'>{ADMINOPTIONS}</div></td>
												</tr>\n";
...
$FORUM_VIEWFORUM_TEMPLATE['sub-header']			= "<tr class='forum-ewlt'>
													<th colspan='2' style='background-color: #1a1a1a;'>".LAN_FORUM_1002."</th>
													<th class='text-center' style='background-color: #1a1a1a;'>".LAN_FORUM_0003."</th>
													<th class='hidden-xs text-center' style='background-color: #1a1a1a;'>".LAN_FORUM_0002."</th>
													<th class='hidden-xs' style='background-color: #1a1a1a;'>".LAN_FORUM_0004."</th>
												</tr>";
...
*/
$FORUM_VIEWFORUM_TEMPLATE['divider-important']	= "<tr><th colspan='2' style='background-color: #1a1a1a;'>".LAN_FORUM_1006."</th>
												<th class='text-center' style='background-color: #1a1a1a;'>".LAN_FORUM_0003."</th>
												<th class='hidden-xs text-center' style='background-color: #1a1a1a;'>".LAN_FORUM_1005."</th>
												<th class='hidden-xs' style='background-color: #1a1a1a;'>".LAN_FORUM_0004."</th>
												</tr>";
$FORUM_VIEWFORUM_TEMPLATE['divider-normal']		= "<tr><th colspan='2' style='background-color: #1a1a1a;'>".LAN_FORUM_1007."</th>
												<th class='text-center' style='background-color: #1a1a1a;'>".LAN_FORUM_0003."</th>
												<th class='hidden-xs text-center' style='background-color: #1a1a1a;'>".LAN_FORUM_1005."</th>
												<th class='hidden-xs' style='background-color: #1a1a1a;'>".LAN_FORUM_0004."</th>
												</tr>";
