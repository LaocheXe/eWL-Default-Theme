...
// Comment Out Used Forum Icons for the Image Versions (old style) //$THEMES_DIRECTORY
define('IMAGE_e', 					'e');
//define('IMAGE_new', 				$tp->toGlyph('fa-star', 'size=2x')); // replace with green-skull
define('IMAGE_new',					'<img src="'.THEME_ABS.'/images/new.png" alt="'.LAN_FORUM_4001.'" title="'.LAN_FORUM_4001.'" />');
//define('IMAGE_nonew', 				$tp->toGlyph('fa-comment', 'size=2x')); // replace with grey-skull
define('IMAGE_nonew', 				'<img src="'.THEME_ABS.'/images/nonew.png" alt="'.LAN_FORUM_4002.'" title="'.LAN_FORUM_4002.'" />');
//define('IMAGE_new_small',  			$tp->toGlyph('fa-star')); // replace with green-skull small
define('IMAGE_new_small', 			'<img src="'.THEME_ABS.'/images/new-small.png" alt="'.LAN_FORUM_4001.'" title="'.LAN_FORUM_4001.'" />');
//define('IMAGE_nonew_small',  		$tp->toGlyph('fa-comment')); // replace with grey-skull small
define('IMAGE_nonew_small', 		'<img src="'.THEME_ABS.'/images/nonew-small.png" alt="'.LAN_FORUM_4002.'" title="'.LAN_FORUM_4002.'" />');
//define('IMAGE_new_popular',  		$tp->toGlyph('fa-comments', 'size=2x'));
define('IMAGE_new_popular', 		'<img src="'.THEME_ABS.'/images/new-pop.png" alt="'.LAN_FORUM_4003.'" title="'.LAN_FORUM_4003.'" />');
//define('IMAGE_nonew_popular', 		$tp->toGlyph('fa-comments-o', 'size=2x'));
define('IMAGE_nonew_popular', 		'<img src="'.THEME_ABS.'/images/nonew-pop.png" alt="'.LAN_FORUM_4004.'" title="'.LAN_FORUM_4004.'" />');
//define('IMAGE_new_popular_small',  	$tp->toGlyph('fa-comments'));
define('IMAGE_new_popular_small', 	'<img src="'.THEME_ABS.'/images/new-pop-small.png" alt="'.LAN_FORUM_4003.'" title="'.LAN_FORUM_4003.'" />');
//define('IMAGE_nonew_popular_small', $tp->toGlyph('fa-comments-o'));
define('IMAGE_nonew_popular_small',	'<img src="'.THEME_ABS.'/images/nonew-pop-small.png" alt="'.LAN_FORUM_4004.'" title="'.LAN_FORUM_4004.'" />');
//define('IMAGE_sticky',  			$tp->toGlyph('fa-thumb-tack', 'size=2x')); // replace with yellow-skull
define('IMAGE_sticky', 				'<img src="'.THEME_ABS.'/images/sticky.png" alt="'.LAN_FORUM_1011.'" title="'.LAN_FORUM_1011.'" />');
//define('IMAGE_stickyclosed',  		$tp->toGlyph('fa-lock', 'size=2x'));
define('IMAGE_stickyclosed', 		'<img src="'.THEME_ABS.'/images/sticky-closed.png" alt="'.LAN_FORUM_1012.'" title="'.LAN_FORUM_1012.'" />');
//define('IMAGE_sticky_small', 		$tp->toGlyph('fa-thumb-tack')); // replace with yellow-skull small
define('IMAGE_sticky_small', 		'<img src="'.THEME_ABS.'/images/sticky-small.png" alt="'.LAN_FORUM_1011.'" title="'.LAN_FORUM_1011.'" />');
//define('IMAGE_stickyclosed_small',  $tp->toGlyph('fa-lock'));
define('IMAGE_stickyclosed_small', 	'<img src="'.THEME_ABS.'/images/sticky-closed-small.png" title="'.LAN_FORUM_1012.'" />');
define('IMAGE_announce',  			$tp->toGlyph('fa-bullhorn', 'size=2x'));
define('IMAGE_announce_small',  	$tp->toGlyph('fa-bullhorn'));
//define('IMAGE_closed_small',  		$tp->toGlyph('fa-lock')); // replace with red-skull small
define('IMAGE_closed_small', 		'<img src="'.THEME_ABS.'/images/closed-small.png" alt="'.LAN_FORUM_1014.'" title="'.LAN_FORUM_1014.'" />');
//define('IMAGE_closed', 				$tp->toGlyph('fa-lock', 'size=2x')); // replace with red-skull
define('IMAGE_closed', 				'<img src="'.THEME_ABS.'/images/closed.png" alt="'.LAN_FORUM_1014.'" title="'.LAN_FORUM_1014.'" />');
//define('IMAGE_noreplies', 			$tp->toGlyph('fa-comment-o', 'size=2x')); // same as nonew
define('IMAGE_noreplies', 				'<img src="'.THEME_ABS.'/images/nonew.png" alt="'.LAN_FORUM_4002.'" title="'.LAN_FORUM_4002.'" />'); // TO DO - No Replies LAN
//define('IMAGE_noreplies_small', 	$tp->toGlyph('fa-comment-o')); // same as nonew
define('IMAGE_noreplies_small', 		'<img src="'.THEME_ABS.'/images/nonew-small.png" alt="'.LAN_FORUM_4002.'" title="'.LAN_FORUM_4002.'" />'); //TO DO - Ne Replies LAN
